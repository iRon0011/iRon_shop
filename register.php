...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      mysqli_query($conn, "INSERT INTO `users`(name, email,address, password) VALUES('$name', '$email','$address', '$pass')") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="address" required placeholder="العنوان " class="box">
